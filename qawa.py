...
def help():
    ...
    print(f"wrap [out] ...... add profiling wrappers to files listed in config.py.")
    ...
    print(f"unwrap .......... restore the original version of the source files from before the wrapping process")
